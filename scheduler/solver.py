...
from constraint import one_band_per_schedule, one_band_per_possible_schedule, close_schedule, Constraint, Constraints
from target import maxmize_band_gap, Target
from output import output_schedule, output_members_schedule
from typing import List


def solver(data_path:str, result_dir: str, column_band_name:int, columns_possible_schedules:List[int], columns_members:List[int], columns_info:List[int], target:Target, constraints:Constraints):
...
if __name__ == "__main__":
    ...
    solver(data_path, result_dir, column_band_name, columns_possible_schedules, columns_members, columns_info, Target.MAXIMIZE_BAND_GAP, constraints)